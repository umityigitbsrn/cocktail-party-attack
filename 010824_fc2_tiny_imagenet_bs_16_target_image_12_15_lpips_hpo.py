...
for target_id in range(12, 16):
    minimize_lpips_for_specific_image_with_id('./model_config/fc2_cocktail_party_tiny_imagenet_instance.json',
                                            ...
                                            logger='./hyperparameter_optimization_log/010824_fc2_tiny_imagenet_bs_16_target_image_{}_lpips_hpo.log'.format(target_id), 
                                            height=64, width=64, device_number=3)